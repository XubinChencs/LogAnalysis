...
public class DrainTree<E> {
	...
	public static class Node<T>{
		...
		public DrainLogGroup addGroup(String log, double ID) {
			DrainLogGroup logGroup = new DrainLogGroup(log, ID);
			groupList.add(logGroup);
			return logGroup;
		}
		
		public DrainLogGroup findGroup(String log) {
			double max_sim = 0;
			double sim = 0;
			int index = -1;
	...
	public DrainLogGroup searchGroup(String log, Node<E> node) {
